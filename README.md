...
<p align="center">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=FFFFFF&center=true&vCenter=true&width=435&lines=Desenvolvedor+Front+End" alt="Typing SVG" />
</p>

Desenvolvo aplicações mantendo uma boa interface, lógica e organização de código, sempre priorizando uma experiência fluída para o usuário.

## 🧠 Como eu trabalho
- Prefiro entender o problema antes de escrever código
- Projeto pensando no amanhã. Uma arquitetura bem organizada hoje evita dores de cabeça amanhã
- Organizo o projeto para ser fácil de evoluir e manter
- Valorizo código simples, legível e com responsabilidades claras
